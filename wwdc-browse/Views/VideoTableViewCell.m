...
- (void)setWwdcVideo:(WWDCVideo *)wwdcVideo
{
    _wwdcVideo = wwdcVideo;
    if (!wwdcVideo.videoTag) {
        [self.videoTagLabel removeFromSuperview];
    }
    UIImage *image = [UIImage imageNamed:wwdcVideo.videoFrameImageURL];
    ...
    self.videoTagLabel.text = wwdcVideo.videoTag;
    self.videoTitleLabel.text = wwdcVideo.videoTitle;
    [self.videoStatusView setUserWatchStatus:wwdcVideo.userWatchStatus];
}
